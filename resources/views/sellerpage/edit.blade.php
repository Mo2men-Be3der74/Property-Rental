...
<head>
    ...
    <title>PropertyHub &mdash; Edit Property</title>
    <link
        rel="stylesheet"
...
<body>
    ...
    <main class="dashboard-content">
        ...
        <section class="dashboard-hero">
            <div class="hero-left">
                <h1 class="hero-title">Edit Property Listing</h1>
                <p class="hero-subtitle">
                    Update your residence details, monthly rates, or architectural photography.
                </p>
            </div>
            ...
            <form action="{{ route('seller.update', ['flat' => $flat->flat_id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon-wrap">
                            ...
                            <input
                                ...
                                value="{{ old('category', $flat->category) }}"
                                required
                            >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon-wrap">
                            ...
                            <input
                                ...
                                value="{{ old('price_per_month', $flat->price_per_month) }}"
                                required
                            >
                        </div>
                    </div>
                ...
                <div class="current-photo-card">
                    ...
                    <div class="current-photo-info">
                        ...
                        <div class="current-photo-subtitle">Upload a new photo below only if you want to replace it</div>
                    </div>
                </div>
